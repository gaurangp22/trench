            ...
            <div className="container max-w-5xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                            ...
                            <div className="prose prose-invert prose-sm max-w-none">
                                {job.description.split('\n').map((line, i) => (
                                    <p key={i} className="text-zinc-400 leading-relaxed mb-2">
                                        {line.startsWith('**') ? (
                        ...
                        <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {job.skills.map((skill) => (
                                    <span
                                        key={skill}
                                        className="px-3 py-1.5 rounded-lg bg-zinc-800 border border-zinc-700 text-sm text-zinc-300"
                                    >
                                        {skill}
                                    </span>
                                ))}
                        ...
                        {/* Client Info */}
                        <div className="bg-zinc-900/30 border border-zinc-800 rounded-xl p-6">
                            <h2 className="text-lg font-semibold text-white mb-4">About the Client</h2>
                        ...
                        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 sticky top-24">
                            ...
                            <div className="text-center mb-6 pb-6 border-b border-zinc-800">
                                ...
                                <div className="text-3xl font-bold text-white mb-1">
                                    ...
                                    <span className="text-lg text-zinc-400 ml-1">SOL</span>
                                </div>
                                <div className="text-sm text-zinc-500">≈ {job.budgetInr}</div>
                            </div>
                            ...
                            <div className={cn(
                                ...
                                <Shield className={cn(
                                    "w-5 h-5",
                                    job.escrowStatus === "funded" ? "text-emerald-400" : "text-zinc-400"
                                )} />
                                <span className={cn(
                                    "text-sm font-medium",
                                    job.escrowStatus === "funded" ? "text-emerald-400" : "text-zinc-400"
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div className="text-center p-3 bg-zinc-800/50 rounded-lg">
                                    <div className="text-lg font-semibold text-white">{job.proposalsCount}</div>
                                    <div className="text-xs text-zinc-500">Proposals</div>
                                </div>
                                <div className="text-center p-3 bg-zinc-800/50 rounded-lg">
                                    <div className="text-lg font-semibold text-white">{job.estimatedDuration}</div>
                            ...
                            {ctaConfig.variant === "wallet" ? (
                                <WalletMultiButton className="!w-full !h-12 !justify-center !bg-gradient-to-r from-purple-500 to-pink-500 !rounded-lg !font-medium" />
                            ) : (
                                <Button
                            ...
                            {!isLoggedIn && (
                                <p className="text-xs text-zinc-500 text-center mt-4">
                                    Already have an account? <Link to="/auth" className="text-purple-400 hover:underline">Log in</Link>
                                </p>
                            )}

                            {/* Message Client Option */}
                            <div className="mt-4 pt-4 border-t border-zinc-800">
                                <button className="w-full flex items-center justify-center gap-2 py-2.5 text-sm text-zinc-400 hover:text-white transition-colors">
